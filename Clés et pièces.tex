...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[height=1em]{piece} \fboyard}
...
Fort Boyard est vraisemblablement une marque déposée, franchement j'ai pas été vérifié. Bref, Fort Boyard est une production Adventure Line Productions, le nom, l'émission, tout ça a priori c'est à eux.
...
L'image de fond est une \href{https://commons.wikimedia.org/wiki/File:Ile_dOleron_on_a_map_of_Blaeu.jpg}{carte de l'île d'Oléron} datant de 1662, dans le domaine public.
